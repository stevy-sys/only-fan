<div class="card card-blog work-box" style=" background-color: <?php echo $config->bg_color_footer ?>; border: none; ">
    @if ($type == 'image')
      @if ($active)
      ...
      ">
        <a data-gallery="portfolioGallery" class="portfolio-lightbox" href="{{$file}}">
