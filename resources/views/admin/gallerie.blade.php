                ...
                <div class="row">
                    ...
                    @foreach ($medias as $media)
                        <div class="col-lg-3 col-md-4 col-xs-6 thumb">
                            <a
                                href="#" data-bs-toggle="modal" data-bs-target="#exampleModal-{{$media->id}}"
                                class="fancybox"
                                rel="ligthbox"
                            >
                                <img
                        ...
                        <div class="modal fade" id="exampleModal-{{$media->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        <a href="{{ route('admin.gallerie.show') }}" class="btn btn-primary">voir</a>
                                    </div>
                                    <div class="mb-3">
                                        <a href="#" class="btn btn-primary">definir Active</a>
                                    </div>
                                    <div class="mb-3">
                                        <a href="{{route('admin.storie.store',['storie' => $media->id])}}" class="btn btn-primary">definier storie</a>
                                    </div>
                                </div>
